                    ...
                    <div class="col-12">
                        <div class="">
                            ...
                            <form method="post" class="form-horizontal"
                                  action="<?= base_url('c_emailrequest/save_updaterequest') ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input name="first_name" type="text" class="form-control" readonly="" value="">
                                    </div>
                                    <label class="col-lg-2 col-form-label">Lastname:</label>
                                    <div class="col-lg-4">
                                        <input name="last_name" type="text" class="form-control" readonly="" value="">
                                    </div>
                                </div>
                                <div class=" form-group row">
