...
<!--                <div class="form-group text-right mb-0"> 
                    <form method="post">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light width-md" onclick="window.location.href = '<?= base_url('c_emailrequest/create/7315760') ?>'">
                    ...
                    <tbody>
                        ...
                        foreach ($data as $row) {
                            ...
                            echo "<td style='text-align: center;'>
								<form action='" . base_url('c_emailrequest/updaterequest') . "' method='POST' style='display:inline;'>
								...
								<form action='" . base_url('c_emailrequest/deleterequest') . "' method='POST' style='display:inline;' class='delete-form' >
								...
								<form action='" . base_url('c_emailrequest/setisdonetrue') . "' method='POST' style='display:inline;' class='markdonerequest-form' >
									<input type='hidden' name='update_id' value='" . $row->id . "'>
									<button type='button' class='btn btn-success waves-effect waves-light markdonerequest-button'>
