                    ...
                    <tbody>
                        ...
                        foreach ($data as $row) {
                            ...
                            echo "<td style='text-align: center;'>
								<form action='" . base_url('c_emailrequest/updaterequest_c') . "' method='POST' style='display:inline;'>
								...
								<form action='" . base_url('c_emailrequest/deleterequest_c') . "' method='POST' style='display:inline;' class='delete-form' >
								...
								<form action='" . base_url('c_emailrequest/setisdonefalse') . "' method='POST' style='display:inline;' class='markundonerequest-form' >
									<input type='hidden' name='update_id' value='" . $row->id . "'>
